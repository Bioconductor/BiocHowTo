...
a given organism. The standardized file format to hold gene models is a 
**[GFF or GTF](https://useast.ensembl.org/info/website/upload/gff.html)**. 
In Bioconductor, gene model information is typically represented as a TxDb 
object but also sometimes as a GRanges or GRangesList object. We can use the
`makeTxDbFromGFF()` function from the `r Biocpkg("txdbmaker")` package to 
import a GFF or GTF file as a *TxDb* object.
